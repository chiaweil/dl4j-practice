...
public class DataVecLab
{
    ...
    private static Logger log = LoggerFactory.getLogger(org.deeplearning4j.examples.feedforward.classification.DataVecLab.class);

    public static void main(String[] args) throws  Exception
    {
        //First: get the dataset using the record reader. CSVRecordReader handles loading/parsing
        File filePath = new ClassPathResource("iris.txt").getFile();
        ...
        DataSet allData = iterator.next(batchSize); //only one dataset in this case
        allData.shuffle();
        ...
        */
        ...
        System.out.println("Number of training data: " + trainingData.numExamples());
        System.out.println("Number of test data: " + testData.numExamples());
