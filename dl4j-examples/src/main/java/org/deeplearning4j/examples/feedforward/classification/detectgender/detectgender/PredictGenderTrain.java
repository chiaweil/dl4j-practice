package org.deeplearning4j.examples.feedforward.classification.detectgender.detectgender;
...
public class PredictGenderTrain
{
    ...
    public static void main(String args[]) throws Exception
    {
        ...
        dg.filePath = new ClassPathResource("PredictGender").getFile().getAbsolutePath() + "/NewData/";
    ...
    public void train() throws Exception
    {
        ...
        while(trainIter.hasNext())
        {
            ...
            eval.eval(model.output(dt.getFeatureMatrix()),model.getLabels());
        }
        trainIter.reset();
        ...
        String modelSaveAs = this.filePath + "PredictGender_new.zip";
