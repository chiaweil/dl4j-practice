package org.deeplearning4j.examples.feedforward.feedforward;
...
public class SimplestNetwork
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        int numInputs = 2; // number of input nodes
        int numOutputs = 2; // number of output nodes
        int nHidden = 100; // number of hidden nodes
        ...
        */
        ...
        System.out.println("Output array: " + output.toString());
